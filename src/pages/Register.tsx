...
const Register = () => {
  ...
  const inputClass = (field: string) =>
    `w-full rounded-xl bg-secondary text-foreground pl-10 pr-4 py-2.5 text-sm border outline-none focus:ring-2 focus:ring-ring transition-all ${
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input type={showPassword ? 'text' : 'password'} value={password} onChange={e => setPassword(e.target.value)} className={`${inputClass('password')} pr-10`} placeholder="вЂўвЂўвЂўвЂўвЂўвЂўвЂўвЂў" />
            ...
            <div>
              ...
              <div className="relative">
                <Lock className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-muted-foreground" />
                <input type="password" value={confirmPassword} onChange={e => setConfirmPassword(e.target.value)} className={inputClass('confirmPassword')} placeholder="вЂўвЂўвЂўвЂўвЂўвЂўвЂўвЂў" />
              </div>
